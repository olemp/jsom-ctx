...
function _getClientContext(url) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, sp_loader_1.SPComponentLoader.loadScript('/_layouts/15/SP.js', { globalExportsName: 'SP' })];
                case 1:
                    _a.sent();
                    if (url) {
                        return [2 /*return*/, new SP.ClientContext(url)];
                    }
                    return [2 /*return*/, SP.ClientContext.get_current()];
            }
        });
    });
}
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = this;
                        return [4 /*yield*/, _getClientContext(this.url)];
                    case 1:
                        _a.clientContext = _b.sent();
